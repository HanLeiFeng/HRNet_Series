...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights of segformer_b0_backbone")
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("model_data/segformer_b2_backbone_weights.pth"), map_location='cuda:0')
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(mit_b3, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone weights of segformer_b3_backbone")
