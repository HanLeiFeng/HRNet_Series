...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, dilated=False, deep_base=False, norm_layer=nn.BatchNorm2d):
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        print("load weights of resnet50")
        model.load_state_dict(torch.load("model_data/resnet50.pth"), strict=False)
