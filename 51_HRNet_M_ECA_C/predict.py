...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = "img/street_01.png"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "E:/01_DataSets/02_CityScapes/ImageSets/Segmentation/"
    org_img_path = 'E:/01_DataSets/02_CityScapes/JPEGImages'
    ...
    if mode == "predict":
        ...
        dir_origin_path = "E:/01_DataSets/02_CityScapes/ImageSets/Segmentation/"
        val_txt_path = dir_origin_path + "val.txt"
        ...
        for img_name in tqdm(img_names):
            ...
            image_path = os.path.join(org_img_path, img_name)
