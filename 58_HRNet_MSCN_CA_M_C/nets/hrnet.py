...
class HRnet(nn.Module):
    def __init__(self, num_classes=21, backbone='hrnetv2_w18', pretrained=False, phi=4):
    ...
    def forward(self, inputs):
        ...
        x0 = self.feat0_attetion(x0)
        x1 = self.feat1_attetion(x1)
        x2 = self.feat2_attetion(x2)
        x3 = self.feat3_attetion(x3)
