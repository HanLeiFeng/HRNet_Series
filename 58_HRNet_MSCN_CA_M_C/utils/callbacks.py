...
class EvalCallback():
    ...
    def get_miou_png(self, image):
        ...
        return image
    '在0——10和eval_period之后进行模型评估'
    def on_epoch_end(self, epoch, model_eval):
        if ((epoch < 5) or (epoch % 20 == 0) or (epoch > self.period)) and self.eval_flag:
            self.net = model_eval
            ...
            for image_id in tqdm(self.image_ids):
                ...
                #   从文件中读取图像
                # -------------------------------#
                image_path = os.path.join(self.dataset_path, "JPEGImages/" + image_id + ".png")
